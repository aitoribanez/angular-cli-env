    ...
    for (let key in fields) {
      switch (fields[key]['type']) {
        case 'string':
          ...
          this.serverFields[key] = 'faker.name.findName()';
          break;

        case 'number':
          this.serverFields[key] = 'Math.floor((Math.random() * 12) + 1)';
          break;

        case 'uuid':
          this.serverFields[key] = 'uuid.v4()';
          break;

        case 'file':
          this.serverFields[key] = '"img/" + i + ".jpg"';
          break;
        /* default:
        default code block */
      }
